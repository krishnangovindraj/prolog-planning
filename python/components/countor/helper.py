...
def tensorConsZero(X, dim, var):
    ...
    #    print(outputTensor1_min,outputTensor1_max,outputTensor2_min,outputTensor2_max)
    #    return outputTensor1_min,outputTensor1_max,outputTensor2_min,outputTensor2_max
